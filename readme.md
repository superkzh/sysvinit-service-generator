...
```sh
wget 'https://raw.githubusercontent.com/superkzh/sysvinit-service-generator/master/new-service.sh' && bash new-service.sh
```
...
```sh
wget 'https://raw.githubusercontent.com/superkzh/sysvinit-service-generator/master/new-service.sh' && sudo bash new-service.sh
```
